...
export default function ContactMe() {
  return (
    <section id='contact-me-section'>
      <ContactLink linkAddress={"www.google.com"} label={"Email Me"} icon={"bi-envelope-fill"} />
      <ContactLink linkAddress={"www.google.com"} label={"You Can Book Me"} icon={"bi-calendar-event-fill"} />
    </section>
  );
}
